...
function DetailPage({ navigate, params }) {
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr auto', gap: 40, alignItems: 'start' }}>
            <div>
              ...
              <h1 style={{ fontSize: 'clamp(24px,3vw,38px)', fontWeight: 800, color: 'white', margin: '0 0 14px', letterSpacing: '-0.6px', textWrap: 'pretty' }}>{f.title}</h1>
                ...
                <div>
                  ...
                  {f.program.map((step, i) => (
                    <div key={i} style={{ display: 'flex', gap: 16, marginBottom: 16 }}>
                      ...
                      <div style={{ fontSize: 14, color: 'var(--text)', lineHeight: 1.6, paddingTop: 4, textWrap: 'pretty' }}>{step}</div>
                    </div>
                  ))}
                </div>
              )}
                ...
                <div>
                  ...
                  {f.objectives.map((obj, i) => (
                    <div key={i} style={{ display: 'flex', gap: 12, marginBottom: 12, alignItems: 'flex-start' }}>
                      ...
                      <div style={{ fontSize: 14, color: 'var(--text)', lineHeight: 1.6, textWrap: 'pretty' }}>{obj}</div>
                    </div>
                  ))}
                </div>
              )}
